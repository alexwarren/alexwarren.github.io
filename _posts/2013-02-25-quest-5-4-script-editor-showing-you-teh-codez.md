...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script1.png"><img class="aligncenter size-full wp-image-2004" alt="Script Adder" src="http://textadventuresblog.files.wordpress.com/2013/02/script1.png" width="426" height="633" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script2.png"><img class="aligncenter size-full wp-image-2006" alt="Editing a script" src="http://textadventuresblog.files.wordpress.com/2013/02/script2.png" width="618" height="150" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script3.png"><img class="aligncenter size-full wp-image-2007" alt="Editing a more complex script" src="http://textadventuresblog.files.wordpress.com/2013/02/script3.png" width="619" height="314" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script4.png"><img class="aligncenter size-large wp-image-2008" alt="Code view for a whole project" src="http://textadventuresblog.files.wordpress.com/2013/02/script4.png?w=625" width="625" height="477" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script5.png"><img class="aligncenter size-full wp-image-2009" alt="Code View button" src="http://textadventuresblog.files.wordpress.com/2013/02/script5.png" width="602" height="346" /></a>

This is the effect of turning on Code View for the whole script:

<a href="http://textadventuresblog.files.wordpress.com/2013/02/script6.png"><img class="aligncenter size-full wp-image-2010" alt="Script Editor Code View - whole script" src="http://textadventuresblog.files.wordpress.com/2013/02/script6.png" width="620" height="161" /></a>

You can also turn on Code View just for any nested script section:

<a href="http://textadventuresblog.files.wordpress.com/2013/02/script7.png"><img class="aligncenter size-full wp-image-2011" alt="Script Editor Code View - nested script section" src="http://textadventuresblog.files.wordpress.com/2013/02/script7.png" width="601" height="311" /></a>

You can make changes in the Code View without having to reload the entire game.

<a href="http://textadventuresblog.files.wordpress.com/2013/02/script8.png"><img class="aligncenter size-full wp-image-2012" alt="Making changes in Code View" src="http://textadventuresblog.files.wordpress.com/2013/02/script8.png" width="621" height="192" /></a>

If you switch back to the English language UI, your changes are immediately reflected in the friendlier version.

<a href="http://textadventuresblog.files.wordpress.com/2013/02/script9.png"><img class="aligncenter size-full wp-image-2013" alt="Making changes in Code View" src="http://textadventuresblog.files.wordpress.com/2013/02/script9.png" width="602" height="408" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script10.png"><img class="aligncenter size-full wp-image-2014" alt="Making a mistake" src="http://textadventuresblog.files.wordpress.com/2013/02/script10.png" width="618" height="206" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script11.png"><img class="aligncenter size-full wp-image-2015" alt="Showing the mistake" src="http://textadventuresblog.files.wordpress.com/2013/02/script11.png" width="603" height="458" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2013/02/script12.png"><img class="aligncenter size-full wp-image-2016" alt="Web Editor Script Code View" src="http://textadventuresblog.files.wordpress.com/2013/02/script12.png" width="620" height="612" /></a>

The Code View button pops up an editor allowing us to view or change the underlying script code.

<a href="http://textadventuresblog.files.wordpress.com/2013/02/script13.png"><img class="aligncenter size-full wp-image-2017" alt="Web Editor Code View" src="http://textadventuresblog.files.wordpress.com/2013/02/script13.png" width="542" height="438" /></a>
