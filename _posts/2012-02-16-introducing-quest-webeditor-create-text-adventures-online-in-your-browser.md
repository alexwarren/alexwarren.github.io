...
<a href="http://textadventuresblog.files.wordpress.com/2012/02/01-create.png"><img class="alignleft size-full wp-image-1101" alt="01 create" src="http://textadventuresblog.files.wordpress.com/2012/02/01-create.png" width="625" height="477" /></a>

Enter a name for your game (you can always change it later), and choose a language.
<p style="text-align:center;"><img class="aligncenter size-full wp-image-1102" title="02 lang" alt="" src="http://textadventuresblog.files.wordpress.com/2012/02/02-lang.png" width="322" height="224" /></p>
Hit the Create button, and your game will be created. This is what it looks like in the editor:

<a href="http://textadventuresblog.files.wordpress.com/2012/02/03-blank-game.png"><img class="alignleft size-full wp-image-1103" alt="03 blank game" src="http://textadventuresblog.files.wordpress.com/2012/02/03-blank-game.png" width="625" height="477" /></a>
...
<p style="text-align:center;"><img class="aligncenter size-full wp-image-1104" title="04 simple mode" alt="" src="http://textadventuresblog.files.wordpress.com/2012/02/04-simple-mode.png" width="414" height="167" /></p>
...
<a href="http://textadventuresblog.files.wordpress.com/2012/02/05-create-exit.png"><img class="alignleft size-full wp-image-1105" alt="05 create exit" src="http://textadventuresblog.files.wordpress.com/2012/02/05-create-exit.png" width="625" height="482" /></a>

I can add an object by clicking the "+ Object" button. Here I've added a sofa, and entered a text description:

<a href="http://textadventuresblog.files.wordpress.com/2012/02/06-add-object.png"><img class="alignleft size-full wp-image-1106" alt="06 add object" src="http://textadventuresblog.files.wordpress.com/2012/02/06-add-object.png" width="625" height="482" /></a>
...
<a href="http://textadventuresblog.files.wordpress.com/2012/02/07-play-game.png"><img class="alignleft size-full wp-image-1107" alt="07 play game" src="http://textadventuresblog.files.wordpress.com/2012/02/07-play-game.png" width="625" height="431" /></a>
...
<p style="text-align:center;"><img class="aligncenter size-full wp-image-1108" title="08 hyperlinks" alt="" src="http://textadventuresblog.files.wordpress.com/2012/02/08-hyperlinks.png" width="218" height="176" /></p>
Here's the game output after looking at the sofa, and moving east into the kitchen.

<a href="http://textadventuresblog.files.wordpress.com/2012/02/09-game.png"><img class="alignleft size-full wp-image-1109" alt="09 game" src="http://textadventuresblog.files.wordpress.com/2012/02/09-game.png" width="625" height="431" /></a>
...
<p style="text-align:center;"><img class="aligncenter size-full wp-image-1110" title="10 run script" alt="" src="http://textadventuresblog.files.wordpress.com/2012/02/10-run-script.png" width="311" height="119" /></p>
...
<a href="http://textadventuresblog.files.wordpress.com/2012/02/11-add-script.png"><img class="alignleft size-full wp-image-1111" alt="11 add script" src="http://textadventuresblog.files.wordpress.com/2012/02/11-add-script.png" width="625" height="467" /></a>
...
<p style="text-align:center;"><img class="aligncenter size-full wp-image-1112" title="12 add youtube" alt="" src="http://textadventuresblog.files.wordpress.com/2012/02/12-add-youtube.png" width="616" height="153" /></p>
And here's what the game looks like if we run it now:

<a href="http://textadventuresblog.files.wordpress.com/2012/02/13-play-youtube.png"><img class="alignleft size-full wp-image-1113" alt="13 play youtube" src="http://textadventuresblog.files.wordpress.com/2012/02/13-play-youtube.png" width="625" height="429" /></a>
