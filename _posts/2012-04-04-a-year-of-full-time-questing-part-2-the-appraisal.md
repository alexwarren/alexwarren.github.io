...
[caption id="attachment_1305" align="alignleft" width="625"]<a href="http://textadventuresblog.files.wordpress.com/2012/04/editor2.png"><img class="size-full wp-image-1305" alt="The desktop editor design..." src="http://textadventuresblog.files.wordpress.com/2012/04/editor2.png" width="625" height="462" /></a> The desktop editor design...[/caption]

[caption id="attachment_1306" align="alignleft" width="625"]<a href="http://textadventuresblog.files.wordpress.com/2012/04/editor1.png"><img class="size-full wp-image-1306" alt="..can mirror the web-based editor design" src="http://textadventuresblog.files.wordpress.com/2012/04/editor1.png" width="625" height="454" /></a> ..can mirror the web editor design[/caption]
...
[caption id="attachment_1376" align="aligncenter" width="394"]<img class="size-full wp-image-1376" title="Desktop Script Editor" alt="" src="http://textadventuresblog.files.wordpress.com/2012/04/desktop-script.png" width="394" height="279" /> The desktop Script Editor is OK, but...[/caption]

[caption id="attachment_1377" align="aligncenter" width="602"]<img class="size-full wp-image-1377" title="Web Script Editor" alt="" src="http://textadventuresblog.files.wordpress.com/2012/04/web-script.png" width="602" height="377" /> ...the web-based Script Editor feels nicer to me[/caption]
...
[caption id="attachment_1365" align="aligncenter" width="277"]<img class="size-full wp-image-1365" title="Object Editor" alt="" src="http://textadventuresblog.files.wordpress.com/2012/04/object.png" width="277" height="363" /> Spot the mistakes![/caption]
...
[caption id="attachment_1367" align="aligncenter" width="571"]<img class="size-full wp-image-1367" title="Object Editor tabs" alt="" src="http://textadventuresblog.files.wordpress.com/2012/04/tabs.png" width="571" height="30" /> The number of tabs is starting to become a problem[/caption]
